...
# -------- MYSQL CONFIG --------
app.config['MYSQL_HOST'] = os.environ.get("MYSQLHOST", "monorail.proxy.rlwy.net")
app.config['MYSQL_USER'] = os.environ.get("MYSQLUSER", "root")
app.config['MYSQL_PASSWORD'] = os.environ.get("MYSQLPASSWORD", "litiLnzmVbjXibLlriJKVWSiTaSQiYuR")
app.config['MYSQL_DB'] = os.environ.get("MYSQLDATABASE", "railway")
app.config['MYSQL_PORT'] = int(os.environ.get("MYSQLPORT", 34577))
...
def checkout():
    ...
    total = sum([p[3] for p in products])  # adjust index if needed
